...
!-=====================================
!-===================================
85 dim mi$(256) : rem dir items
103 gosub 21000 : rem load screen
105 gosub 17000 : rem load array
110 gosub 17500 : rem load 1st time menu
120 db$ = "mn(array index) = " + str$(mn) : gosub 16000 : rem DEBUG
200 get a$ : if a$ = "" then 200
205 rem print asc(a$)
210 if asc(a$) = 17 then md=0: gosub 19000 : rem down arrow
215 if asc(a$) = 145 then md=1: gosub 19000 : rem up arrow
225 goto 200
300 end

#region DEBUG print2screen 1600
15999 rem === print DEBUG to screen at row, col
16000 poke rx,3: poke ry,21: poke rf,0: sys65520
16010 print "{space*36}"
16015 poke rx,3: poke ry,21: poke rf,0: sys65520
...
19000 rem
19005 gosub 19500: rem clear old selection
...
19710 p1= 4 + mn: pa$=mi$(mn):  gosub 20000
19799 return
#endregion
